...
# ACCOUNT REQUEST FOR cn-account2

module "cn-account2" {
  source = "./modules/aft-account-request"

  control_tower_parameters = {
    AccountEmail              = "alchdli.odd+cnaccount2@gmail.com"
    AccountName               = "cn-account2"
    ManagedOrganizationalUnit = "AFT"
    SSOUserEmail              = "alchdli.odd+cnaccount2@gmail.com"
    SSOUserFirstName          = "cn-account2"
    SSOUserLastName           = "AFT"
  }
  ...
  account_customizations_name = "cn-account2"
}
